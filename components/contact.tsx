...
import { stats, contact, trackConversion } from "@/config/site-config";
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <a
              ...
              className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl border border-blue-200 hover:bg-blue-100 transition-colors group"
            >
              <FaEnvelope className="w-5 h-5 text-blue-600" />
              <div className="text-left">
                <div className="font-medium text-blue-900">Email</div>
                <div className="text-sm text-blue-700 group-hover:underline">
                  {contact.email}
                </div>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-sm text-green-700 group-hover:underline">
                  {contact.whatsapp}
                </div>
              </div>
            </a>
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            <div className="bg-white rounded-xl p-4 border border-gray-200">
              ...
              <div className="text-xs text-gray-600">{stats.responseTimeLabel}</div>
            </div>
            <div className="bg-white rounded-xl p-4 border border-gray-200">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200 shadow-soft">
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  className="h-12 px-4 rounded-lg borderBlack transition-all w-full mobile-button"
              ...
              <textarea
                className="h-32 rounded-lg borderBlack p-4 transition-all w-full resize-none"
                name="message"
