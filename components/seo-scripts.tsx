          ...
          __html: `
            ...
            function gtag_report_conversion(url) {
              ...
              gtag('event', 'conversion', {
                  'send_to': '${analytics.googleAdsConversions.contactForm}',
                  'value': 1.0,
                  'currency': 'INR',
            ...
            // Generic conversion tracking function for future use
            function gtag_report_custom_conversion(conversionId, value = 1.0, currency = 'INR', url) {
              var callback = function () {
                if (typeof(url) != 'undefined') {
                  window.location = url;
                }
            ...
            window.gtag_report_custom_conversion = gtag_report_custom_conversion;
          `,
        }}
      />
    </>
